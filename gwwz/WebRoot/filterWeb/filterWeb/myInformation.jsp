...
<html>
  ...
  <tr height="60">
    <td><font size="2" color="#999999">Where are you now：<a href="../" target="_top">Homepage</a>&gt; My information</font></td>
  </tr>
</table>
    <table style="font-size: 13px;margin-top: 20px" width='960px' align="center">
    	<%
			...
			out.println("<tr><td height='30' colspan='2'><font color='#0099FF' size='3'><strong>account information：</strong></font></td></tr>");
			out.println("<tr><td height='30' style='padding-left:20px'><font color='#666666'><strong>Account&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;number：</strong></font></td><td width='600' style='padding-left:20px'>"+customerInfo.getEmail()+"</td></tr>");
			out.println("<tr><td height='30' style='padding-left:20px'><font color='#666666'><strong>Registration time：</strong></font></td><td style='padding-left:20px'>"+v.datemmddtime(customerInfo.getRegisterTime())+"</td></tr>");
			...
			out.println("<tr><td height='30' style='padding-left:20px'><font color='#666666'><strong>pass&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;word：</strong></font></td><td width='600' style='padding-left:20px'><input id='regPwd' type='password' name='regPwd' style='width:200px;height:19px;padding-top: 3px'/></td></tr>");
			...
			out.println("<tr><td  height='30' colspan='2'><font color='#0099FF' size='3'><strong>Latest personal delivery information：</strong></font></td></tr>");
			if(customerDetailInfo == null){
				out.println("<tr><td height='30' style='padding-left:20px'><font color='#666666'><strong>Real&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;name：</strong></font></td><td style='padding-left:20px'>Never filled in</td></tr>");
				out.println("<tr><td height='30' style='padding-left:20px'><font color='#666666'><strong>Fixed phone：</strong></font></td><td style='padding-left:20px'>Never filled in</td></tr>");
				out.println("<tr><td height='30' style='padding-left:20px'><font color='#666666'><strong>Mobile phone：</strong></font></td><td style='padding-left:20px'>Never filled in</td></tr>");
				out.println("<tr><td height='30' style='padding-left:20px'><font color='#666666'><strong>Delivery address：</strong></font></td><td style='padding-left:20px'>Never filled in</td></tr>");
			}
			else{
				out.println("<tr><td height='30' style='padding-left:20px'><font color='#666666'><strong>Real&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbspname：</strong></font></td><td style='padding-left:20px'>"+customerDetailInfo.getName()+"</td></tr>");
				out.println("<tr><td height='30' style='padding-left:20px'><font color='#666666'><strong>Fixed phone：</strong></font></td><td style='padding-left:20px'>"+customerDetailInfo.getTelphone()+"</td></tr>");
				...
				out.println("<tr><td height='30' style='padding-left:20px'><font color='#666666'><strong>Delivery address：</strong></font></td><td style='padding-left:20px'>"+customerDetailInfo.getAddress()+"</td></tr>");
			}
			out.println("<tr><td colspan='2'><hr color='#FF6699' style='height:1px'/></td></tr>");
			out.println("<tr><td height='30' colspan='2'><font color='#0099FF' size='3'><strong>Orders placed：</strong></font></td></tr>");
        	...
        	out.println("<td width='170'><div align='center'><font color='#666666'>Order date</font></div></td>");
 			out.println("<td width='170'><div align='center'><font color='#666666'>Operation</font></div></td>");
 			out.println("</tr>");
 			if(orderList.size() == 0){
 				out.println("<tr><td height='30' colspan='4'><div align='center'>You haven't placed any orders!</div></td></tr>");
 			}
 			else{
 				for(int i=0;i<orderList.size();i++){
 					OrderInfo orderInfo = orderList.get(i);
 					String status = "Not confirmed <a href='#' onclick=th("+orderInfo.getOrderId()+")>Return goods</a>";
 					if(orderInfo.getStatus() == 1){
 						status = "Has been confirmed <a href='#' onclick=sh("+orderInfo.getOrderId()+")> Confirm receipt</a>";
 					}
        			...
        			out.println("<td><div align='center'><a href='../servlet/OrderInfo?method=showOrderInfo&orderId="+orderInfo.getOrderId()+"'>View details</a></div></td>");
			...
			/*out.println("<tr><td height='30' colspan='2'><font color='#0099FF' size='3'><strong>Evaluated products：</strong></font></td></tr>");
			if(goodsEvaluateList.size() == 0){
				out.println("<tr><td height='40' style='padding-left:20px' colspan='2'>You haven't made any service evaluation yet!</td></tr>");
			}
			else{
				...
				for(int i=0;i<goodsEvaluateList.size();i++){
					...
					out.println("<tr><td height='40' style='padding-left:20px'>"+goodsEvaluateInfo.getEvaluateTime()+"</td><td>You&nbsp;&nbsp;<font color='#666666'><strong>"+goodsInfo.getGoodsName()+"</strong></font>&nbsp;&nbsp;said："+goodsEvaluateInfo.getGoodsEvaluate()+"</td></tr>");
				}
			}
			out.println("<tr><td colspan='2'><hr color='#FF6699' style='height:1px'/></td></tr>");*/
    	%>
