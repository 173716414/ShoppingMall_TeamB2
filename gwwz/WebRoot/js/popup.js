var tcolor={
    ...
    tColor:"#9C9E9C", //镙囬鑳屾櫙棰滆壊锛岃竟妗嗛鑹?
    wColor:"#FFFFFF" //镙囬鏂囧瓧棰滆壊
   };
...
var Popup=new Class();
Popup.prototype={
iframeIdName:'ifr_popup', //iframe镄勫悕瀛?
initialize:function(config){
   this.config=Object.extend({ //灞炴€ц缃?
    contentType:1, //pop绫诲瀷 1. 鍐呭祵iframe锛?. 鏄剧ず缁椤畾镄删tml 3. confirm妗?4. alert妗?
    isHaveTitle:true, //鏄惁链夋爣棰樻爮
    scrollType:'yes', //鍐呭祵iframe鏄惁鍙互婊氩姩
    isBackgroundCanClick:false, //鑳屾櫙鏄惁鍙互镣瑰向
    isSupportDraging:true, //鏄惁鏀寔鎷栧姩
    isShowShadow:true, //鏄惁鏄剧ず阒村奖
    isReloadOnClose:true, //鍏抽棴鍚庢槸鍚﹂吨鏂板姞杞介〉闱?
    width:400, //瀹藉害
    height:300 //楂桦害
   },config||{});
   this.info={ //鍙傛暟
    shadowWidth:0, //阒村奖瀹藉害
    title:"", //镙囬
    contentUrl:"", //iframe镄剈rl
    contentHtml:"", //鍐呭镄删tml
    callBack:null, //锲炶皟鍑芥暟
    parameter:null, //璋幂敤镄勫弬鏁?濡?{id:"divCall",str:"镣瑰向纭畾鍚庢樉绀虹殑瀛楃涓?,obj:pop}
    confirmCon:"", //confirm镄勫唴瀹?
    alertCon:"", //alert镄勫唴瀹?
    someHiddenTag:"select,object,embed", //镊姩闅愯棌镄勯〉闱㈠厓绱?
    someDisabledBtn:"", //绂佺敤镄刡tn
    someHiddenEle:"", //闅愯棌镄勫寑阃?
    overlay:0, //瑕嗙洊
    coverOpacity:0 //钂欑毊涓嶉€忔槑搴?
   };
    this.color=tcolor;
    this.dropClass=null;
    this.someToHidden=[];
...
setContent:function(arrt,val){ //璁剧疆鍐呭锛屽嵆 this.info 镄勫弬鏁板唴瀹?
   if(val!=''){
    switch(arrt){
...
build:function(){
   ...
   var close='<img id="dialogBoxClose" title="鍏抽棴" src=/jpkc/img/dialogclose.gif  />';
   ...
   oDialog['style']['left']=sleft+"px"; //宸︿晶浣岖疆
   oDialog['style']['top']=220+"px"     //椤堕儴浣岖疆
   },
